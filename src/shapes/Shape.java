 ...
 * for all 3D geometric shapes. Each shape has a height, and subclasses
 * implement methods to calculate base area and volume.
 * 
 * <p>
 * Implements {@link Comparable} to sort by height by default.
 * 
 * <p>
 * Subclasses include specific geometric solids such as:
 * <ul>
...
public abstract class Shape implements Comparable<Shape>
{
	 ...
	 *
	 * <p>
	 * This method must be implemented by all subclasses, as each shape has a
	 * different formula for volume calculation.
	 *
	 ...
	 *
	 * <p>
	 * This method must be implemented by all subclasses, since each shape has its
	 * own unique base area formula.
	 *
	 ...
	 *
	 * <p>
	 * This method defines the natural ordering of shapes. It returns:
	 * <ul>
	 ...
	 *
	 * <p>
	 * By default, this method returns the class name (e.g.,
	 * {@code shapes.Cylinder}, {@code shapes.Pyramid}).
	 *
